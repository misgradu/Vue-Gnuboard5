  ...
  <div v-if="p" class="m-5">
    ...
    <t-card class="shadow bg-white" v-if="p.member.mb_nick"> 
      <template v-slot:header>
        ...
        <div class="p-3 border-2 border-blue-500 bg-blue-300 rounded flex justify-between"> 
          <div> 보유포인트 </div>
        ...
        <div class="p-3 border-2 border-gray-500 bg-gray-300 rounded flex justify-between"> 
          <div> 소계 </div>
          <div> {{p.member.mb_point | number_format}} </div>
        </div>
