<template>
  <div>
    ...
    <!-- 댓글 시작 { -->
    <p v-if="c.list.length == 0" id="bo_vc_empty" class="mx-3 border py-6 rounded bg-white px-3 text-center dark:hover:bg-gray-600 dark:bg-gray-900 dark:border-gray-400">등록된 댓글이 없습니다.</p>
        ...
        <div class="flex flex-wrap mb-6">
            <div class="bo_vc_w_info flex">
              <div v-if="c.is_guest">
                ...
                <input type="text" name="wr_name" :value="c.ck_sns_name" id="wr_name" required class="mr-3 sm:w-auto w-1/2 bg-gray-100 rounded border border-gray-400 leading-normal resize-none py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white dark:focus:bg-gray-700 dark:bg-gray-900" size="25" placeholder="이름">
                <label for="wr_password" class="sound_only">비밀번호<strong> 필수</strong></label>
                <input type="password" name="wr_password" id="wr_password" required class="sm:w-auto w-1/2 bg-gray-100 rounded border dark:focus:bg-gray-700 dark:bg-gray-900 border-gray-400 leading-normal resize-none py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white" size="25" placeholder="비밀번호">
              </div>
